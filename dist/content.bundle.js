  ...
  function calculate(a, b, operator) {
    switch (operator) {
      ...
      case "*":
        ...
        break;
      case "/":
        return b !== 0 ? parseFloat((a / b).toFixed(2)) : Infinity;
        break;
      case "%":
        return a * b / 100;
        break;
  ...
  `;
    ...
    <div style="display: flex; padding: 9px;">
      ...
      <div style="display: flex; flex-direction: column; margin-left: 10px; gap: 5px;">
        ...
        <button class="op-btn" data-op="-" style="padding: 6px;">\u2212</button>
        <button class="op-btn" data-op="*" style="padding: 6px;">\xD7</button>
        <button class="op-btn" data-op="/" style="padding: 6px;">\xF7</button>
        <button class="op-btn" data-op="%" style="padding: 6px;">%</button>
      </div>
    </div>
  `;
